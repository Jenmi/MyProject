				...
				if($.browser.msie&&$.browser.version==6.0){
					$("body").scroll(function(event) {
						...
						if(objTop<=settings.distance){
							...
							//改变颜色
							if(top<120){
								$(obj).css("background","rgba(101, 110, 126, "+(objTop/30)+")");
							}else if(top<200){
								$(obj).css("background","rgba(101, 110, 126, "+(objTop/10)+")");
							}else if(top<300){
								$(obj).css("background","rgba(101, 110, 126, "+(objTop/5)+")");
							}else{
								$(obj).css("background","rgba(101, 110, 126, 0.8)");
							}
						}
						if($(obj).offset().top<=100){//initPos						
