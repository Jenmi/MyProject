...
!function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        html.push('<th style="text-align: center; vertical-align: middle; ">option_op</th>');//这里
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            html.push('<tr',
                ...
                sprintf(' data-Id="%s"', this.header.fields[0]),
                '>'
            );
            ...
            //自己添加的属性，是否有操作
            if(this.options.opEdit || this.options.opShow || this.options.opDelete){
            	var id = item[this.header.fields[0]];
            	var opString = "<td>";
            	 if(this.options.opEdit){
            		 opString+="<a href='javascript:' onclick='tableEdit(this,"+id+")' class='opEditClass'><i class='glyphicon glyphicon-pencil'></i> </a>&nbsp;&nbsp;";//这里
                 }
            	 if(this.options.opShow){
            		 opString+="<a href='javascript:' onclick='tableShow(this,"+id+")' class='opShowClass'><i class='glyphicon glyphicon-eye-open'></i></a>&nbsp;&nbsp;";//这里
                 }
            	 if(this.options.opDelete){
            		 opString+="<a href='javascript:' onclick='tableDelete(this,"+id+")' class='opDelClass'><i class='glyphicon glyphicon-remove'></i></a>&nbsp;&nbsp;";//这里
                 }
            	 opString += "</td>";
            	 html.push(opString);
            }
