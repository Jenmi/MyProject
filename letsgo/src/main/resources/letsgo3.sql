...
(
	...
	bad_num int COMMENT '吐槽次数',
	see_num int COMMENT '查看次数',
	-- 创建时间
	create_date datetime COMMENT '创建时间',
	update_date date COMMENT '修改时间',
	comment_num int COMMENT '评论次数',
	user_id int NOT NULL COMMENT '用户ID',
	type_id int NOT NULL COMMENT '博客类型id',
	PRIMARY KEY (blog_id)
) COMMENT = '博客';
...
(
	img_id int NOT NULL COMMENT '博客图片id',
	img_path varchar(50) COMMENT '图片路径',
	-- 图片类型
	-- 1.图片标题
	-- 2.图片内容
	img_type int(2) COMMENT '图片类型',
	img_content varchar(50) COMMENT '图片内容',
	-- 创建时间
	create_date datetime COMMENT '创建时间',
	-- 是否被删除
	-- 1,是
...
(
	...
	-- 访问者ip
	visit_ip varchar(30) COMMENT '访问者ip',
	login_name varchar(20) COMMENT '登陆者名字',
...
(
	...
	-- 访问者ip
	visit_ip varchar(30) NOT NULL COMMENT '访问者ip',
	login_id int COMMENT 'login_id',
	email_title varchar(100) NOT NULL COMMENT '邮件标题',
	eamil_content varchar(250) COMMENT '邮件内容',
	email_name varchar(30) COMMENT '发送人名',
	email_address varbinary(20) NOT NULL COMMENT '邮件地址',
	email_phone varbinary(20) COMMENT '发送者电话',
	to_userid  COMMENT '发送给谁',
	-- 创建时间
	create_date datetime COMMENT '创建时间',
	-- 1是
	-- 2否
...
(
	...
	photo_path varchar(50) COMMENT '路径',
	photo_title varchar(50) COMMENT '图片标题',
	photo_content varchar(100) COMMENT '图片内容',
	-- 创建时间
	create_date datetime COMMENT '创建时间',
	-- 是否被删除
	-- 1,是
...
(
	visit_id int NOT NULL AUTO_INCREMENT COMMENT 'visit_id',
	visit_ip varchar(30) COMMENT '拜访者IP',
	login_name varchar(20) COMMENT '登陆者名',
